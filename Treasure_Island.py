...
crossraod = input('You\'re at a crossroad. Where do you want to go? Type "left" or "right"')
...
if crossraod == "left":
    ...
    if lake == "wait":
         ...
         if doors == "red":
             print("you died cause of fire")
         elif doors == "yellow":
            print("you found the tresure")
         elif doors == "blue" :
            print("zeus used lighting bolt and killed you")
        
    elif lake == "swim":
        print("You died cause of crocodiles")
    else:
        print("didnt understand input you died")
elif crossraod == "right":
    print("A tiger was there you died")
else:
    print("didnt understand input you died")
